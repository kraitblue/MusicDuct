...
namespace MusicDuct.Controllers
{
    public class RegistrationController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("UserId,Username,Pwd,Confirmpwd,Email")] User user)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("UserId,Username,Pwd,Confirmpwd,Email")] User user)
        {
            if (id != user.UserId)
            {
                return NotFound();
